...
This directory is the long-lived project wiki. It stores curated knowledge that
is expected to grow across multiple investigation rounds.

Use `docs/references/` for source-specific reference notes. Use this wiki when
the information has become project knowledge and should be organized by topic.
...
- Prefer small topic pages over one growing document.
